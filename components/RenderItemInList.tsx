...
export default class RenderItemInList extends React.PureComponent<Props, any> {
				...
				>
					...
					>
						<View style={StyleSheet.imageView}>
							<ItemImg size={175} medias={item.Medias} />
						</View>
						<View style={{ width: size / 2, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start'}}>
